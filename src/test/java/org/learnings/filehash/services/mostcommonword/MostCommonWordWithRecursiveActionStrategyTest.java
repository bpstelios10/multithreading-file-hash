...
class MostCommonWordWithRecursiveActionStrategyTest {

    private final MostCommonWordWithRecursiveActionStrategy strategy = new MostCommonWordWithRecursiveActionStrategy();
    ...
    @Test
    public void getMostCommonWordImproved_whenEmptyText() {
