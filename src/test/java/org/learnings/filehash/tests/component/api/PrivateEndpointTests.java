...
public class PrivateEndpointTests {
    ...
    void getActuatorLinks() throws Exception {
        mockMvc.perform(get("/file-hashes/private").accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
    ...
    void getActuatorMetrics() throws Exception {
        ...
        mockMvc.perform(get("/file-hashes/private/metrics"))
                .andExpect(status().isOk())
    ...
    void getActuatorConfigProps() throws Exception {
        mockMvc.perform(get("/file-hashes/private/configprops"))
                .andExpect(status().isOk())
    ...
    void getActuatorEnv() throws Exception {
        mockMvc.perform(get("/file-hashes/private/env"))
                .andExpect(status().isOk())
    ...
    void getActuatorHeapdump() throws Exception {
        mockMvc.perform(get("/file-hashes/private/heapdump"))
                .andExpect(status().isOk());
    }

    @Test
    void getActuatorHealth() throws Exception {
        mockMvc.perform(get("/file-hashes/private/health"))
                .andExpect(status().isOk())
    ...
    void getActuatorLivenessCheck() throws Exception {
        mockMvc.perform(get("/file-hashes/private/health/liveness"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$['status']").value("UP"));
    }
    ...
    void getActuatorReadinessCheck() throws Exception {
        mockMvc.perform(get("/file-hashes/private/health/readiness"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$['status']").value("UP"));
    }
}
